...
<body class="bg-gradient" style="background-color: #ffd1dc;">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="img/site_logo.jpg" style="display: block; margin-left: auto; margin-right: auto; height: 250px;">
              <br>
              <div style="text-align: center;"><h4><b>SITE<br>Violations and Attendance<br>System</b> </h4></div>
            </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="login_proc.php">
                    ...
                    if (isset($_SESSION['login'])){
                      ...
                      <span style="color: red; font-weight: bold;">&nbsp;&nbsp;Wrond username or password</span>
                      <br>
                    <?php
                    }
                    ?>
